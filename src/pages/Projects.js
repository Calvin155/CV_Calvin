  ...
  const projects = [
    {
      ...
      description: 'Portable air quality monitor system using a Raspberry Pi 5, Enviromental Sensors, Mobile Application developed using Swift, Web Applciation using React, FastAPI (Restful-Server) (Docker), InfluxDB (Docker) & AWS Cloud hosting for Rest server & database.',
